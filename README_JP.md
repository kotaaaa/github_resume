...
現在は，Webアプリケーションエンジニアとして，家電ECサービスのバックエンド，フロントエンド，運用業務を幅広く担当している．
修士の自然言語処理，データマイニングに関する実装分析スキルとWebアプリケーションエンジニアとしての開発スキルの双方を活かして，より機械学習のドメインを対象とした開発業務に携わりたいと考えている．
